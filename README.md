 ...
 * Everything can be versioned as the final files are generated and saved
 ...
 * Flekszible vs Helm: 
   * It's based on composition instead of templates
   ...
   * You don't need to add a lot of golang template condition to customize all the parts of k8s resources
 ...
 * Flekszible vs Kustomize:
   ...
   * It tries to be more user friendly (easier syntax, flexible composition, it can work without adding any resource file)
